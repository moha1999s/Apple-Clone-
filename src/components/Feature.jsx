...
import AudioImg from "@/assets/images/audio_books__gnptwfxaw7mi_large.jpg";
import potential from "@/assets/images/potential__cyozlyqjit8i_large.jpg";
import rec1 from "@/assets/images/recommendations_01__d88jya0se9me_large.jpg";
import rec2 from "@/assets/images/recommendations_02__bjegtfnpl1le_large.jpg";
import iclod from "@/assets/images/icloud_sync__dvdxrjzr3q82_large.jpg";
    ...
    return (
        <section className=" bg-gray-200 my-24 py-12">
            <div className="continer">
                ...
                <div>
                    <h1 className="text-4xl md:text-6xl text-center tracking-tight font-bold pt-12 pb-6 ">A novel reading and <br />
                        listening experience.</h1>
                </div>

                <div className="bg-white rounded-xl md:mx-auto  md:max-w-[824px] mx-3 mt-10 px-8 md:px-16 py-7 my-2">
                    <h1 className="mb-1 md:text-2xl text-2xl font-bold tracking-tighter">Listen to audiobooks right in the app.</h1>
                    <p className="text-gray-600 font-bold md:font-bold  md:text-xl pt-2 tracking-tighter">Audiobooks is a tab right inside the Apple Books app,
                ...
                <div className="bg-white rounded-xl mt-4 md:mx-auto md:max-w-[824px] mx-2 px-4 md:px-16 py-10 ">
                    <h1 className="mb-1 md:text-2xl text-3xl font-bold tracking-tighter">Pick up where you left off.</h1>
                    <p className="text-gray-600 md:text-xl text-sm font-bold tracking-tighter">iCloud syncs your progress. So even when you switch devices, you’ll pick up right where you left off in your audiobook or ebook. And download your Apple Books titles to your device for offline reading or listening.
